...
class Import extends CI_Controller {
	...
	public function siswa() {
        ...
        if($file[$length -1] == 'xlsx' || $file[$length -1] == 'xls') {
            ...
            $strq = "INSERT INTO siswa (nim, nama, jurusan) VALUES ";
           
            $strq .= implode(",", $data).";";
            
            $this->db->query($strq);
        } else {
            exit('Bukan File Excel...');
        }
        redirect('adm/siswa');
	}
	...
	public function guru() {
        ...
        if($file[$length -1] == 'xlsx' || $file[$length -1] == 'xls') {
            ...
            $strq = "INSERT INTO guru (nip, nama) VALUES ";
    ...
    public function soal() {
        ...
        if($file[$length -1] == 'xlsx' || $file[$length -1] == 'xls') {
            ...
            $strq = "INSERT INTO soal_ujian (id_guru, id_mapel, bobot, soal, opsi_a, opsi_b, opsi_c, opsi_d, opsi_e, jawaban, tgl_input, jml_benar, jml_salah) VALUES ";
