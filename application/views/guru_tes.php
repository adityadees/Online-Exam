    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="alert alert-info">
          <a href="#" onclick="return view_petunjuk('petunjuk');">Guide</a>
          <div id="petunjuk">
            <ul>
              <li><b>Jumlah Soal</b> : Silahkan masukan soal sesuai dengan jumlah soal yang telah dibuat</li>
              <li><b>Waktu Mulai</b> : Waktu awal untuk mengikuti ujian</li>
              <li><b>Waktu Selesai</b> : Batas waktu akhir untuk mengikuti ujuan</li>
              <li><b>Acak Soal</b> : Soal akan di acak atau di urutkan sesuai inputan awal</li>
              <li><b>Waktu Ujian</b> : Total waktu yang diberikan dalam mengikuti ujian</li>
            </ul>
          </div>
        </div>
        ...
        <form name="f_ujian" id="f_ujian" onsubmit="return m_ujian_s();">
          ...
          <table class="table table-form">
            ...
            <tr>
              <td>Tgl Mulai</td>
              <td>
                <input type="date" name='tgl_mulai' class="form-control col-md-6"  style="display: inline; float: left" id="tgl_mulai" placeholder="Tgl" data-tooltip="waktu awal boleh menge-klik tombol \"mulai\" ujian" required>
                <input type="time" name='wkt_mulai' class="form-control col-md-6"  style="display: inline; float: left" id="wkt_mulai" placeholder="Waktu" required>
              </td>
            </tr>
            <tr>
              <td>Tgl Selesai</td>
              <td>
                <input type="date" name='terlambat' class="form-control col-md-6"  style="display: inline; float: left" id="terlambat" placeholder="Tgl" required>
                <input type="time" name='terlambat2' class="form-control col-md-6"  style="display: inline; float: left" id="terlambat2" placeholder="Waktu" required>
              </td>
            </tr>
            <tr>
              <td>Waktu Ujian</td>
