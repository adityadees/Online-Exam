<div class="content-header row">
  <div class="content-header-left col-md-6 col-12 mb-2">
    <h3 class="content-header-title mb-0">Data Mata Pelajaran</h3>
  ...
  <div class="content-header-right col-md-6 col-12">
    <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
      <a class="btn btn-outline-primary" href="#" onclick="return mata_pelajaran_e(0);"><i class="ft-plus"></i></a>
    </div>
  </div>
</div>
...
<div class="modal fade" id="mata_pelajaran" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="f_mapel" id="f_mapel" onsubmit="return mata_pelajaran_s();">
